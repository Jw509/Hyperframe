...
const MANUAL_SEGMENTS = [
  ...
  // EXTENDED v10->v11: was 159-163 (4s), now 158-164.5 (6.5s) for full thumb slide
  { start: 158.0, end: 164.5, note: "DeSean Bishop solo (Tennessee, full thumb slide)", tag: "first-of-pack", pack: 2 },
  ...
  // EXTENDED v10->v11: was 208.5-211.5 (3s), now 207.5-212.5 (5s) for full thumb slide
  { start: 207.5, end: 212.5, note: "Luke Hasz solo (pack 3 first card, full thumb slide)", tag: "first-of-pack", pack: 3 },
  ...
  // PACK 5 — College Rule Playbook insert (Georgia) at src 4:59, Van Buren at src 5:05
  { start: 297.5, end: 301.5, note: "College Rule Playbook insert - Georgia (4:57.5-5:01.5, full thumb slide)", pack: 5 },
  { start: 303.5, end: 307.5, note: "Michael Van Buren solo (Mississippi State, 5:03.5-5:07.5)", pack: 5 },
];
...
// SKIP the duplicate Van Buren area (host shuffles cards, auto-detect picks
// up Van Buren twice). User says real Van Buren is at src 5:05 (handled by
// manual segment above). Block 308-330 to prevent dupe.
OVERRIDE_ZONES.push({ start: 307.5, end: 330.0, reason: "SKIP — Van Buren duplicate (handled at 5:05)" });
