#!/usr/bin/env python
"""Generate a 2-second title-hook overlay (GibbSigg / brand red style).
Style: red rounded banner + bold white text with heavy black outline
(matches the user's red-overlay brand / reference image).
Full-canvas 2160x3840 transparent PNG -> overlaid at 0:0 in ffmpeg, enabled 0-2s.
Text (verbatim): "Autograph and Numbered Card In Same Pack?"
"""
from PIL import Image, ImageDraw, ImageFont, ImageFilter

W, H = 2160, 3840
OUT = "scratch/overlay-preview/gibbsigg_hook_overlay.png"
...
# Controlled wrap; words stay exactly as typed, all white, balanced lines like the reference.
LINES = ["Autograph and", "Numbered Card", "In Same Pack?"]
SIZE = 150
