...
Report: scratch/render-audit/bowman-v11-reveal-gate-after-harness-fix.md
...
| warning | P9C2->P9C3 | card-035 | KC Concepcion | pre-slide hold is below 1.2s | transition=9:43.950, slideEnd=9:44.600, hold=0.52s, slide=0.65s | This is human-reviewed; recheck only if the render still feels rushed. |
| warning | P19C1->P19C2 | card-074 | Jerrick Gibson | pre-slide hold is below 1.2s | transition=18:29.550, slideEnd=18:30.200, hold=0.55s, slide=0.65s | This is human-reviewed; recheck only if the render still feels rushed. |
