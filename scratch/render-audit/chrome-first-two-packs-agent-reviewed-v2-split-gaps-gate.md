...
Catalog: briefs/catalogs/chrome.first-two-packs.agent-reviewed-v1.json
Cut: briefs/cuts/chrome.first-two-packs.agent-reviewed-v2-split-gaps.json
Report: scratch/render-audit/chrome-first-two-packs-agent-reviewed-v2-split-gaps-gate.md
...
| warning | P2C2->P2C3 | card-009 | Art Monk | pre-slide hold is below 1.2s | transition=4:03.300, slideEnd=4:04.300, hold=0.87s, slide=1.00s | This is human-reviewed; recheck only if the render still feels rushed. |
