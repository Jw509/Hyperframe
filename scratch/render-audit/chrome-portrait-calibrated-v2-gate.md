...
Report: scratch/render-audit/chrome-portrait-calibrated-v2-gate.md
...
|---|---|---|---|---|---|---|
| blocker | P1C4->P1C5 | card-005 | Jakobi Meyers | slide window is below 0.55s | transition=2:30.470, slideEnd=2:30.970, hold=1.50s, slide=0.50s | Extend the slide with revealEndSeconds or correct the reveal start. |
